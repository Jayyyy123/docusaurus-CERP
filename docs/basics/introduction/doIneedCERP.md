---
id: doIneedCERP
title: Do I Need an CERP?
sidebar_label: Do I Need an CERP?
---

CERP is a modern tool that covers not only accounting, but also all other business functions, on an integrated platform. It has many benefits over both traditional accounting as well as CERP applications.
...
Benefits over big CERP

- $$$ - Saves money.
- **Easier to configure**: Big CERP are notoriously hard to setup and will ask you a zillion questions before you can do something meaningful.
