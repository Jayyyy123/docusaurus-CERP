...
sidebar_label: Payment Terms Template
---
...
A Payment Terms Template tells CERP how to populate the table in the 'Payment Terms Schedule' section of the sales/purchase document.
