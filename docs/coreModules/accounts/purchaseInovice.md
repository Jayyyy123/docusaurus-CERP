...
The Update Stock checkbox should be checked if you want CERP to automatically update your inventory. Consequently, there will be no need for a Delivery Note.
